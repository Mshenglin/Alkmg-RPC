package com.xu.remoting.transport.netty.codec;


import com.xu.compress.Compress;
...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    public RpcMessageDecoder() {
        // lengthFieldOffset: magic code是4B, version是1B，然后是full length所以值是
        // lengthFieldLength:全长4B。所以值是4
        // lengthAdjustment: full length include all data and read 9 bytes before，所以left length is (fullLength-9)值是-9
       // 我们将手动检查magic code和version，所以不要删除任何字节。所以值是0
